        ...
        $(
            paste::item! {
                ...
                fn [<test_ $ty _try_from_hashmap>]() {
                    let expected = [<Model$ty>] { attr: Some(10) };
                ...
                fn [<test_ $ty _try_from_hashmap_into_none>]() {
                    let expected = [<Model$ty>] { attr: None };
    ...
    ($($ty:ty),*) => {
        $(
            paste::item! {
                ...
                #[test]
                fn [<test_ $ty _try_from_hashmap>]() {
                    let expected = [<Model$ty>] { attr: Some(1.2) };
